        ...
        <div className='container mx-auto bg-gray-50'>
            <section className='md:flex md:flex-row justify-between items-center pl-5'>
                <div className='md:w-1/2'>
                    ...
                    <button className='text-lg md:text-[20px] px-5 md:px-7 py-3 md:py-4 bg-gradient-to-r from-[#7E90FE] to-[#9873FF] rounded-lg font-semibold text-white'>Get Started</button>
                </div>

                <div className='md:w-1/2'>
                    <img src="/assets/All Images/P3OLGJ1 copy 1.png" alt="banner Image" />
                </div>
            </section>
        </div>
