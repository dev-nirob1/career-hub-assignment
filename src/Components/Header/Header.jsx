...
const Header = () => {
    ...
    return (
        <div className=' flex justify-between items-center container mx-auto h-20'>
            ...
            <button className='text-base text-[20px] text-white px-4 md:px-5 py-3 md:py-4  bg-gradient-to-r from-[#7E90FE] to-[#9873FF] font-semibold rounded-lg'>Start Applying</button>
